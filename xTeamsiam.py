...
\033[1;91m☞ Auther     : ABDUR_RAHMAN_SIAM
\033[1;92m☞ WhatsApp   : +8801822200169
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update S4_SIAM Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' team - SIAM  Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/s4_Siam)
	    os.system('cd $HOME && git clone https://github.com/teamsiam/xTeamsiam.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('WhatsApp Num +8801822200169✓')
	    psb('WellCome To TEAM -_ SIAM')
	    psb('Congratulations ABDUR RAHMAN SIAM Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ SIAM✓')
	    psb('🔓Password ☆ 001100✓')
	    psb('Add with Me in [Facebook] https://www.facebook.com/siamahmmed01873✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/SIAM && python2 B4.py')
	elif bm =='3':
